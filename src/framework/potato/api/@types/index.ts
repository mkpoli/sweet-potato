...
export type SonolusResourceLocator = {
  ...
  type: 'SkinData' | 'EngineThumbnail' | 'EffectData' | 'SkinTexture' | 'ParticleData' | 'EffectThumbnail' | 'LevelBgm' | 'BackgroundThumbnail' | 'EngineConfiguration' | 'LevelData' | 'LevelPreview' | 'ParticleTexture' | 'BackgroundData' | 'EngineData' | 'BackgroundImage' | 'LevelCover' | 'SkinThumbnail' | 'ParticleThumbnail' | 'BackgroundConfiguration'
...
export type Upload = {
  ...
  type: 'SkinData' | 'EngineThumbnail' | 'EffectData' | 'SkinTexture' | 'ParticleData' | 'EffectThumbnail' | 'LevelBgm' | 'BackgroundThumbnail' | 'EngineConfiguration' | 'LevelData' | 'LevelPreview' | 'ParticleTexture' | 'BackgroundData' | 'EngineData' | 'BackgroundImage' | 'LevelCover' | 'SkinThumbnail' | 'ParticleThumbnail'
}

/** It specifies what search query supported */
export type Search = {
  options: (Partial<SearchTextOption & SearchSliderOption & SearchToggleOption & SearchSelectOption>)[]
}
